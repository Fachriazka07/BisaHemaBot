...
bot.command('help', async (ctx) => {
  const helpText = [
    ...
    '',
    '─── *BACKDATE TRANSAKSI* ──────',
    '`keluar <kat> <nominal> <dompet> kemarin`',
    '`keluar <kat> <nominal> <dompet> tanggal 12 agustus`',
    '`masuk <kat> <nominal> <dompet> lusa`',
    '',
    '─── *SCAN STRUK & BUKTI TF* ───',
    '📸 Kirim foto struk, transfer bank, e-wallet, atau QRIS',
    '',
    '─── *DASHBOARD* ─────────────────',
